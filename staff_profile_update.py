...
print("""
            ...
            <ul class="sub-menu collapse" id="service">
                <li><a href="./staff_all_dep_view.py?id=%s">All DEPARTMENT</a></li>
                <li><a href="./staff_bca_dep_view.py?id=%s">BCA DEPARTMENT</a></li>
                <li><a href="./staff_it_dep_view.py?id=%s">B.Sc IT DEPARTMENT</a></li>
                <li><a href="./staff_cs_dep_view.py?id=%s">B.Sc CS DEPARTMENT</a></li>
            </ul>"""% (pid))
print("""
            ...
            <ul class="sub-menu collapse" id="new">
                ...
                <li><a href="./staff_certificate_req_view.py?id=%s">View</a></li>
            </ul>
"""% (pid))
print("""
            ...
            <ul class="sub-menu collapse" id="new2">
                <li><a href="./staff_leave_req.py?id=%s">add</a></li>
                <li><a href="./staff_leave_req_view.py?id=%s">view</a></li>
            </ul>
            """% (pid))

print("""
            <li>
                <a href="./staff_salary_view.py?id=%s">
                    Salary View
                </a>
            </li>"""% (pid))
print("""
