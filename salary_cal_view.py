...
print("""
<table border="1" style="margin-left:510px;" cellpadding="15" cellspacing="15">
<tr>
<th>stf_id</th>
<th>name</th>
<th>Department</th>
...
for i in res:
    ...
    print("""
    <td>
    <a href="./salary_calculation.py?staff_id=%s"><button>Calculate Salary</button></a>
    </td>
    </tr>
    """% i[1])
print("""
