...
<div class="col-md-7">
<center>
<p style="color:red;"><b>STAFF DETAILS</b></p>
</center>
...
for i in rec:
    ...
    print("""<tr>
       ...
       """ % (i[1], i[2], i[3], i[4], i[5], i[6], i[8], i[12], fn))
    print("""
       <td>
        <a href="./admin_staff_update.py?id=%s"><button>More</button></a>
       </td>
       </tr>
    """ % i[0])
print("""
