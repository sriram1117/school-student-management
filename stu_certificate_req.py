...
q1="""select max(id) from stu_req_detail"""
cur.execute(q1)
r=cur.fetchone()
...
<body>
    ...
    <div class="nav-side-menu">
        ...
        <div class="menu-list">
            ...
            <ul class="sub-menu collapse" id="products">
                <li><a href="./stu_certificate_req.py">Add</a></li>
                <li><a href="./stu_certificate_req_view.py">View</a></li>
            </ul>
    ...
    <div class="main">
        <center>
            <h2 style="font-family:Georgia, 'Times New Roman', Times, serif; color: #230124; margin-left:20px;">
                Student Request form</h2>
        </center><br>
...
<input class="form-control" type="text" name="name" placeholder="Name" maxlength="20" required><br>
            ...
            <select class="form-control" type="text" name="receving" maxlength="20" required>
                <option value="" disabled selected>Receiving Certificate Through</option>
                <optgroup>
                    <option value="mail">By Mail</option>
                    <option value="Head office">Head Office</option>
                </optgroup><br>
            </select><br>
            <select class="form-control" type="text" name="certificate" maxlength="20" required>
                <option value="" disabled selected>Certificates</option>
                <optgroup>
                    <option value="Mark">Mark Sheet</option>
                ...
                <input class="form-control" type="text" name="pwd" placeholder="Password"
                        maxlength="20" required><br>
                <input class="form-control btn btn-info btn-success" type="Submit" name="sub"
...
prec=form.getvalue("receving")
pcer=form.getvalue("certificate")
...
if psubmit!=None:
    q = """insert into Stu_req_detail (stu_id,name,dob,department,receive,certificate,contact,emailid,address,city,state,username,password)
         values('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')""" % (pstuid,pname,pdob,pdep,prec,pcer,pcontact,pemail_id,paddr,pcity,pstate,puserna,ppass)
    cur.execute(q)
    conn.commit()
    print("""
        <script>
