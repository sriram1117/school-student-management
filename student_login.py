...
<body>
    ...
    <div class="form">
        ...
        <center>
            <img src="./Image/stu img.jpg" alt="Avatar" class="avatar" height="200px" width="200px"><br><br>
            <form action="" method="post" target="_self" style="width: 350px;" enctype="multipart/form-data">
                <div class="form-group mb-3">
                    <label for="uname"><b>USERNAME</b></label>
                    <input placeholder="ENTER USERNAME" type="text" name="name" class="form-control" required>

                </div>
                <div class="form-group mb-3">
                    <label for="psw"><b>PASSWORD</b></label>
                    <input placeholder="ENTER PASSWORD " type="password" name="pwd"
...
if psubmit!=None:
    ...
    q="""select id from student_detail where username='%s' and password='%s'""" %(puname,ppwd)
    ...
    if rec!=None:
        print("""
          <script>
           ...
           location.href="student_dashboard.py?id=%s";
        </script>
        """ % rec[0])
    else:
        print("""
